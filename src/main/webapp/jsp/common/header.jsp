...
<link
  ...
  rel="stylesheet" />
<link
  href="${pageContext.request.contextPath}/resources/css/library/fontawesome-6.4.2.all.min.css"
  rel="stylesheet" />
<link
...
<script
  src="${pageContext.request.contextPath}/resources/js/library/jquery-3.7.1.min.js"
  type="text/javascript"></script>
<script
