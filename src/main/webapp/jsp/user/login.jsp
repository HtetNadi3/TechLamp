...
<body>
	<section>
		...
		<form action="${pageContext.request.contextPath}/signin" method="post" class="signin">
			<div class="content">
				<h2>Login</h2>
				<c:if test="${not empty loginError}">
					<div style="padding: 10px; border: 1px solid red; text-align: center; color: red;">${loginError}</div>
				...
				<div class="form">
					...
					<div class="links">
						<a href="#">Don't have an account?</a> <a
