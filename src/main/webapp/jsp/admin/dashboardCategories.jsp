			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
				...
				<div
					...
					<div class="btn-toolbar mb-2 mb-md-0">
						<a href="${pageContext.request.contextPath}/dashboard/category/new"
							class="btn glass"> <i class="fas fa-plus"></i> Add Category
						</a>
					</div>
				</div>
						...
						<tbody>
							...
							<c:forEach var="category" items="${categoryList}">
								<tr>
									...
									<td class="d-flex"><a href="edit?id=${category.id}"
