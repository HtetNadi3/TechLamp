        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar glass">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/dashboard/allUsers">
                        <i class="fas fa-users"></i> Users
                    </a></li>
                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/dashboard/category/list">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card glass">
                            <div class="card-body d-flex flex-column align-items-center text-center">
                                <i class="fas fa-blog fa-lg pt-2" style="color: rgb(62, 246, 74);"></i>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card glass">
                            <div class="card-body d-flex flex-column align-items-center text-center">
                                <i class="fas fa-users fa-lg pt-2" style="color: rgb(68, 99, 241);"></i>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card glass">
                            <div class="card-body d-flex flex-column align-items-center text-center">
                                <i class="fas fa-layer-group fa-lg pt-2" style="color: rgb(237, 166, 79);"></i>
